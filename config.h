...
static char normbordercolor[]       = "#AAF683";
static char normfgcolor[]           = "#d8dee9";
static char selfgcolor[]            = "#2e3440";
static char selbordercolor[]        = "#FF9B85";
static char selbgcolor[]            = "#FF9B85";
...
static char *colors[][3] = {
		...
		[SchemeInfoNorm]  	= { normfgcolor,	"#4C566A",  	"#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
